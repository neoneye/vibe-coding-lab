...
Loads (kg): bucket 10, crate 40, gold bars 100 (a 4 kg pallet with eight 12 kg bars), barrel 150, aquarium 300, unicorn 400, car 1000. With 50 kgf that ladder needs 1, 1, 2, 3, 6, 8 segments; the car needs 20 and is intentionally beyond the 8× maximum so the "add more" hint has a case that cannot be satisfied.
...
- **Unicorn.** (Replaced the cow, 2026-09-05.) A white unicorn with a rainbow mane and tail and a golden spiral horn, slung around its barrel. When it lands after falling off, or a cut rope drops it, the horn snaps off and lies on the floor. It stands dazed with stars circling its head for 1.5 s, then turns furious (red eye, furrowed brow, snorting) and gallops at 2.6 m/s toward the puller, charging through him, turning at the scene edges and coming back for another pass, forever. Each charge makes him leap and shout "AAAH!". Load reads "none — it is chasing him". Hanging a new load ends the rampage.
