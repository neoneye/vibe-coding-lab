...
Loads (kg): bucket 10, crate 40, gold bars 100 (a 4 kg pallet with eight 12 kg bars), barrel 150, piano 300, cow 400, car 1000. With 50 kgf that ladder needs 1, 1, 2, 3, 6, 8 segments; the car needs 20 and is intentionally beyond the 8× maximum so the "add more" hint has a case that cannot be satisfied.
