...
const EXPECT = {
  ...
  assumed_floor_exceeds_local_certificate: ['propext', 'Quot.sound'],
  projection_at_assumed_floor_lower:  ['propext', 'Quot.sound'],
  projection_at_assumed_floor_upper:  ['propext', 'Quot.sound'],
  projection_at_assumed_floor_ordering: ['propext', 'Quot.sound'],
