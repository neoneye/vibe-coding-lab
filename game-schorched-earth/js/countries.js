...
window.SE.COUNTRIES = [
    ...
    { id: 'denmark', name: 'Denmark', colors: ['#c8102e', '#ffffff', '#c8102e'] },
    { id: 'brazil',  name: 'Brazil',  colors: ['#009c3b', '#ffdf00', '#002776'] },
    { id: 'japan',   name: 'Japan',   colors: ['#ffffff', '#bc002d', '#ffffff'] },
    { id: 'india',   name: 'India',   colors: ['#ff9933', '#ffffff', '#138808'] },
    { id: 'sweden',  name: 'Sweden',  colors: ['#006aa7', '#fecc02', '#006aa7'] }
];
